...
const Feed = () => {
  const [allPosts, setAllPosts] = useState<Array<PromptType>>([]);

  // Search states
  const [searchText, setSearchText] = useState<string>("");
  const [searchTimeout, setSearchTimeout] = useState<
    ReturnType<typeof setTimeout> | string | number | undefined
  >();
  const [searchedResults, setSearchedResults] = useState<Array<PromptType>>([]);
